...
import { Axis, D3Component } from '../D3ReactBase';
...
export default class ScatterplotD3 extends D3Component {
  ...
  preRender() {
    let {data, xAccessor, yAccessor, xScale, yScale, dotRadiusScale,
      dotRadiusAccessor} = this.props;
  ...
  render() {
    let {data, xAccessor, yAccessor, xScale, yScale, dotRadius, dotRadiusScale,
      dotRadiusAccessor, dotColorScale, dotColorAccessor} = this.props;
